      ...
      <div class="header">
        <div class="logo logo-dark">
          <a href="index.html">
            ...
            <img
              class="logo-fold"
              :src="image_url + '/backend/assets/images/logo/logo-fold.png'"
              alt="Logo"
            />
          </a>
        </div>
        <div class="logo logo-white">
          <a href="index.html">
            <img
              :src="image_url + '/backend/assets/images/logo/logo-white.png'"
              alt="Logo"
            />
            <img
              class="logo-fold"
              :src="
                image_url + '/backend/assets/images/logo/logo-fold-white.png'
              "
              alt="Logo"
            />
          </a>
            ...
            <li class="dropdown dropdown-animated scale-left">
              <div class="pointer" data-toggle="dropdown">
                <div class="avatar avatar-image m-h-10 m-r-15">
                  <img
                    :src="
                      image_url + '/backend/assets/images/avatars/thumb-3.jpg'
                    "
                    alt=""
                  />
                </div>
                  ...
                  <div class="d-flex m-r-50">
                    <div class="avatar avatar-lg avatar-image">
                      <img
                        :src="
                          image_url +
                          '/backend/assets/images/avatars/thumb-3.jpg'
                        "
                        alt=""
                      />
                    </div>
