            ...
            <div class="d-flex flex-column justify-content-between w-100">
                <div class="container d-flex h-100">
                    <div class="row align-items-center w-100">
                        <div class="col-md-7 col-lg-5 offset-md-3 m-h-auto">
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between m-b-30">
                                        <img class="img-fluid" alt="" :src="image_url+'/backend/assets/images/logo/logo.png'">
                                    ...
                                    <form @submit.prevent="signIn">
                                        <div class="form-group">
                                            ...
                                            <div class="input-affix">
                                                ...
                                                <input type="text" class="form-control" id="email" placeholder="email" v-model="signInForm.email">
                                            </div>
                                        </div>
                                        <div class="form-group mt-4 mb-4">
                                            ...
                                            <div class="input-affix m-b-10">
                                                ...
                                                <input type="password" class="form-control" id="password" placeholder="Password" v-model="signInForm.password">
                                            </div>
                                        </div>
                                        <div class="form-group">
